...
public class AuthIntegrationTests : IntegrationTestsSetup
{
    ...
    public async Task Auth_ShouldAllowRequest_WhenValidCredentialsAreSent()
    {
        ...
        var getResponse = await _client.GetAsync("Boards/65cbec3865a3b4fbed6945aa/Columns/65cbec6d65a3b4fbed6945ab/Cards");
    ...
    private static IEnumerable<object[]> GetUnauthorizeParameters()
    {
        ...
        {
            new object[] { "GET", "Boards/65cbec3865a3b4fbed6945aa/Columns/65cbec6d65a3b4fbed6945ab/Cards" },
            new object[] { "POST","Boards/65cbec3865a3b4fbed6945aa/Columns/65cbec6d65a3b4fbed6945ab/Cards" },
            new object[] { "DELETE", "Boards/65cbec3865a3b4fbed6945aa/Columns/65cbec6d65a3b4fbed6945ab/Cards/65c6e255a03db52a8056230f" },
